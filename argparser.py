...
def get_argparser():
    ...
    parser.add_argument("--model", type=str, default='deeplab', choices=['deeplab', 'segformer'])
    ...
    parser.add_argument(
        "--val_interval", type=int, default=15, help="epoch interval for eval (default: 1)"
    )
    parser.add_argument(
